...
int main( int argc, char** argv )
{
	...
	for(int i=0; i < height;i++){
			    ...
			    int val[3] = {0,0,0};
					...
					if(x<0) x=0;
					if(y<0) y=0;
					val[0]+=refer.at<Vec3b>(x,y)[0]*weigth[a][b];
					val[1]+=refer.at<Vec3b>(x,y)[1]*weigth[a][b];
					val[2]+=refer.at<Vec3b>(x,y)[2]*weigth[a][b];
				}
			    }
		            image.at<Vec3b>(i,j)[0] = val[0]/16;
			    image.at<Vec3b>(i,j)[1] = val[1]/16;
			    image.at<Vec3b>(i,j)[2] = val[2]/16;
                    }
        }
